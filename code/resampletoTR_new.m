...
% 
% 
function [resamp_time,resamp_data] = resampletoTR_new(TR,time_file,gas_file)
...
formatSpec = '%f';
fileID_t = fopen(time_file,'r'); 
time = transpose(fscanf(fileID_t,formatSpec));
fileID_g = fopen(gas_file,'r');
data = transpose(fscanf(fileID_g,formatSpec));
